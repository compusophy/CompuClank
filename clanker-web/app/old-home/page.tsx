...
import { Users, Coins, TrendingUp, Wallet, Loader2, Check, Search, X, ArrowLeft } from "lucide-react"
...
function CabalCard({
  ...
  // Determine phase label and styles
  const getPhaseDisplay = () => {
    ...
    const styles = {
      ...
      [CabalPhase.Closed]: "bg-gray-500/10 text-gray-500 border-gray-500/30",
    }
    return {
...
export default function OldHomePage() {
  ...
  // Watch for cabals being finalized
  useWatchContractEvent({
    address: CABAL_DIAMOND_ADDRESS,
    abi: CABAL_ABI,
  ...
  if (!CABAL_DIAMOND_ADDRESS) {
    return (
      <div className="min-h-screen pb-[80px] bg-golden-radial">
        <header className="sticky top-0 z-50 glass-golden border-b border-primary/10">
          <div className="page-container">
            <div className="flex items-center justify-between h-14">
              <span className="text-xl font-bold tracking-tight text-golden-animated">CABAL (Legacy)</span>
    ...
    <div className="min-h-screen pb-[80px] bg-golden-radial">
        ...
        <div className="page-container">
          <div className="flex items-center justify-between h-14">
            <div className="flex items-center gap-3">
              ...
              >
                CABAL <span className="text-sm text-muted-foreground">(Legacy)</span>
              </button>
            </div>
            <div className="flex items-center gap-3">
              <WalletButton />
      ...
      <main className="page-container py-3.5">
        {isViewingDetails ? (
          ...
          <>
            {/* Legacy Notice */}
            <Card className="p-3 mb-4 bg-yellow-500/10 border-yellow-500/30">
              <p className="text-sm text-yellow-600 dark:text-yellow-400 text-center">
                ⚠️ Legacy View - These are old cabals before the Fractal DAO update. Use this to manage existing positions.
              </p>
            </Card>
            ...
            {isLoading ? (
              ...
              <Card className="p-3.5 text-center max-w-lg mx-auto border-dashed">
                <div className="space-y-3.5 py-3.5">
                  ...
                  <div className="space-y-3.5">
                    <div>
                      <p className="font-semibold text-base">No Legacy CABALs</p>
                      <p className="text-xs text-muted-foreground mt-1">No old cabals found.</p>
                    </div>
                  </div>
                </div>
              </Card>
