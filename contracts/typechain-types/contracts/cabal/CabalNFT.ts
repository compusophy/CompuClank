...
export interface CabalNFTInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "approve"
      | "balanceOf"
...
export interface CabalNFT extends BaseContract {
  connect(runner?: ContractRunner | null): CabalNFT;
  waitForDeployment(): Promise<this>;

  interface: CabalNFTInterface;
